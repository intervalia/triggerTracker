 ...
 */
(function ($, undefined) {
  var trackOn = false, trackHandlers = true, handlerTimeIndex = 0,
      stoppedEventPropandDefault = "Event propagation was stopped and default action was prevented.",
      con = $.triggerTrackerConsole || window.console;
  ...
  if (con !== undefined) {
    ...
    function trackable(eventType) {
      var trackable = true, et = eventType;
